...
4. [为什么要重置浏览器中的HTML元素默认的CSS样式？] 
5. [请谈谈你对Normalize.css的理解。] 
6. [如果要制作UI库需要考虑哪些方面？]   
7. [除了Bootstrap，还听过或用过哪些其它前端框架？]  
...
15. [如果要设置伸缩容器中子元素的显示顺序，可以用哪个属性实现？]  
...
3. [把CSS属性background-attachment设为哪一个值，能把背景图像附着到内容上，使得图像会随着内容一起滚动。] 
